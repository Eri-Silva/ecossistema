...
<div class="container">
<form action="../database/animal/animalStoreDB.php" method="post">
<h1>Registro de animal:</h1>
    ...
    <label for="formGroupExampleInput">Id do bioma que ele vive: </label>
    <input type="number" name="ani_bio_id" class="form-control" id="formGroupExampleInput" placeholder="Ex: 1, 2, etc." required>

  <button class="btn btn-primary">Enviar</button></a></button>
</form>
</div>
